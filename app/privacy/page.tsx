      ...
      <main className="flex-1 py-20 px-6">
        <div className="max-w-3xl mx-auto prose dark:prose-invert">
          ...
          <div className="space-y-6 text-muted-foreground">
            <p><strong>Stu-Dos values the privacy of its users and is committed to protecting personal information shared with us.</strong></p>
            ...
            <p>Stu-Dos does not sell, rent, or share personal data with third parties for marketing or commercial purposes.</p>
            ...
            <div className="bg-secondary p-4 rounded-lg mt-8">
                ...
                <a href="mailto:stu.dos.official@gmail.com" className="text-primary hover:underline">stu.dos.official@gmail.com</a>
            </div>
          </div>
        </div>
      </main>
