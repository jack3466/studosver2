      ...
      <main className="flex-1 py-20 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6 text-muted-foreground leading-relaxed">
            <p className="font-medium text-foreground">Stu-Dos believes in transparency and fairness.</p>
            ...
            <p>Any refund decision will be at the sole discretion of Stu-Dos.</p>
