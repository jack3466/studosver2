      ...
      <main className="flex-1 py-20 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6 text-muted-foreground leading-relaxed">
            <p>STUEHUB is a student support service provider. We offer guidance, assistance, and support based on experience and best practices.</p>
            ...
            <p>STUEHUB is not affiliated with any government body, university, or corporate organization unless explicitly stated.</p>
